    ...
    class Chibatao
    {
        ...
        private void inserirNoBancoSuperTerminais()
        {
            ...
            try
            {
                ...
                query = "insert into Chibatao (NFe , DIDOC , ARMAZENAGEM1 , PESAGEM , PESAGEMQNT , SEGURO , SEGUROQNT , INSNEVASIVACONTAINERS , INSNEVASIVACONTAINERSQNT , ADMINISTRATIVO , ADMINISTRATIVOQNT , COLOCACAODOLACRE , COLOCACAODOLACREQNT , QUEBRADOLACRE , QUEBRADOLACREQNT , TRANSINTERNO , TRANSINTERNOQNT , INFRAESTRUTURAAQUAVIARIA , INFRAESTRUTURAAQUAVIARIAQNT , ISPSCODE , ISPSCODEQNT) values ('" + nfe + "','" + DIDOC + "','" + armazenagem1 + "','" + pesagem + "'," + pesagemqnt + ",'" + seguro + "'," + seguroqnt + ",'" + inspnevasiva + "'," + inspnevasivaqnt + ",'" + administrativo + "'," + administrativoqnt + ",'" + colocacaodelacre + "'," + colocacaodelacreqnt + ",'" + quebradolacre + "'," + quebradolacreqnt + ",'" + TransInt + "'," + TransIntqnt + ",'" + arquaviaria + "'," + arquaviariaqnt + ",'" + ISPSCode + "'," + ISPSCodeqnt + ")";
