...
namespace BetterBotPMM
{
    class AuroraEadi
    {
        ...
        string entreganoturno;
        int entreganoturnoqnt;
        ...
        private void inserirNoBancoEadi()
        {
        ...
        private void findEntregaNoturno()
        {
            int indexbegin = dis.IndexOf("ADICIONAL SOBRE ENTREGA NOTURNO");
            //Console.WriteLine(indexbegin);
            if (indexbegin != -1)
            {
                int indexEnd = dis.Substring(indexbegin).IndexOf(";");
                ...
                int indexmoney = dis.Substring(indexbegin).IndexOf("$");
                indexbegin += indexmoney + 2;
                entreganoturno = dis.Substring(indexbegin, indexEnd - indexbegin);
                entreganoturnoqnt = int.Parse(dis.Substring(indexbegin - 7, 1));
                Console.WriteLine("Entrega Noturno: " + entreganoturno);
            }
            else
            {
                entreganoturno = "";
